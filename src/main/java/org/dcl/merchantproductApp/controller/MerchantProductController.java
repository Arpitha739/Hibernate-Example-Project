package org.dcl.merchantproductApp.controller;
...
import org.dcl.merchantproductApp.dao.MerchantDao;
import org.dcl.merchantproductApp.dao.ProductDao;
import org.dcl.merchantproductApp.dto.Merchant;
import org.dcl.merchantproductApp.dto.Product;
...
public class MerchantProductController {
	...
	private static void findProductsByCategory() {
		...
		List<Product>lpdb=pdao.findProductsByCategory(category);
		if(lpdb.size()>0)
		{
		...
		{
			System.err.println("No Product info found since category name is invalid");
		}	
	}
	...
	{
		System.out.println("Enter the Product info with id =>  (id,name,brand,category,cost)");
		...
		if (pdb != null) {
			System.out.println("Product Record is updated");

		} else {
			System.err.println("Product info is not updated");
		}
	}
	...
	private static void saveMerchant() {
		System.out.println("Enter Merchant name,phone,gst,email,password");
		String name = sc.next();
		...
		System.out.println("Merchnat info is Saved eith an id " + mdb.getId());
